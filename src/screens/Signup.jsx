...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://go-food-inxp.vercel.app/api/auth/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://go-food-inxp.vercel.app/api/auth/createuser", {
      // credentials: 'include',
